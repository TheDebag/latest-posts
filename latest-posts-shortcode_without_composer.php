 ...
 * Description: Displays a list of the latest posts using a shortcode. Includes a settings page to adjust the number of posts displayed.
 * Version: 1.0
...
// Шорткод для вывода последних постов
